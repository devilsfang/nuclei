...
<p align="center">
  ...
  <a href="https://github.com/devilsfang/nuclei/blob/main/README_JP.md">日本語</a>
</p>
</p>
...
We have a [dedicated repository](https://github.com/devilsfang/nuclei-templates) that houses various type of vulnerability templates contributed by **more than 300** security researchers and engineers.
...
Nuclei has built-in support for automatic template download/update as default since version [v2.5.2](https://github.com/devilsfang/nuclei/releases/tag/v2.5.2). [**Nuclei-Templates**](https://github.com/devilsfang/nuclei-templates) project provides a community-contributed list of ready-to-use templates that is constantly updated.
...
Complete guide of using Nuclei as Library/SDK is available at [godoc](https://pkg.go.dev/github.com/devilsfang/nuclei/v3/lib#section-readme)
...
Thanks to all the amazing [community contributors for sending PRs](https://github.com/devilsfang/nuclei/graphs/contributors) and keeping this project updated. :heart:
