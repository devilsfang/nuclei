...
import (
	...
	generator "github.com/devilsfang/nuclei/v3/pkg/js/devtools/bindgen"
...
func process() error {
	...
	for _, module := range modules {
		...
		data, err := generator.CreateTemplateData(filepath.Join(dir, module), "github.com/devilsfang/nuclei/v3/pkg/js/libs/")
		if err != nil {
