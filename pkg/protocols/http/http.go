...
import (
	...
	httputil "github.com/devilsfang/nuclei/v3/pkg/protocols/utils/http"
...
type Request struct {
	...
	// Deprecated: request condition will be detected automatically (https://github.com/devilsfang/nuclei/issues/2393)
...
func (request *Request) Compile(options *protocols.ExecutorOptions) error {
	...
	if len(request.Payloads) > 0 {
		// Due to a known issue (https://github.com/devilsfang/nuclei/issues/5015),
