...
import (
	...
	"github.com/devilsfang/nuclei/v3/pkg/fuzz"
	...
	"github.com/devilsfang/nuclei/v3/pkg/protocols/common/helpers/eventcreator"
	"github.com/devilsfang/nuclei/v3/pkg/protocols/common/helpers/responsehighlighter"
	...
	protocolutils "github.com/devilsfang/nuclei/v3/pkg/protocols/utils"
...
func (request *Request) executeRequestWithPayloads(input *contextargs.Context, payloads map[string]interface{}, previous output.InternalEvent, callback protocols.OutputEventCallback) error {
	...
	// Ref: https://github.com/devilsfang/nuclei/pull/5545#discussion_r1721291013
